<template>
    <v-container class="fill-height">
        <v-responsive class="align-centerfill-height mx-auto" max-width="900">
            ...
            <v-row>
                <v-col cols="12">
                    <v-card class="py-4 bg-primary" color="secondary"
                        image="https://cdn.vuetifyjs.com/docs/images/one/create/feature.png"
                        prepend-icon="mdi-rocket-launch-outline" rounded="lg" variant="outlined" title="se">
                        <template #title>
                            <h2 class="text-h5 font-weight-bold color-secondary">primary</h2>
                        </template>
                        <template #subtitle>
                            <h2 class="text-h5 font-weight-bold color-white">primary</h2>
                        </template>
                    </v-card>
                </v-col>

                <v-col cols="12">
                    <v-card class="py-4 bg-secondary" color="primary"
                        image="https://cdn.vuetifyjs.com/docs/images/one/create/feature.png"
                        prepend-icon="mdi-rocket-launch-outline" rounded="lg" variant="outlined" title="se">
                        <template #title>
                            <h2 class="text-h5 font-weight-bold color-secondary">primary</h2>
                ...
                <v-col cols="12">
                    <v-card class="py-4 bg-info" color="primary"
                        image="https://cdn.vuetifyjs.com/docs/images/one/create/feature.png"
                        prepend-icon="mdi-rocket-launch-outline" rounded="lg" variant="outlined" title="se">
                        <template #title>
                            <h2 class="text-h5 font-weight-bold color-secondary">primary</h2>
...
<v-overlay opacity=".12" scrim="warning" contained model-value persistent />
</v-card>
</v-col>
...
<v-col cols="6">
    <v-card append-icon="mdi-open-in-new" class="py-4" color="surface-variant" href="https://vuetifyjs.com/"
        ...
        variant="text">
        <v-overlay opacity=".06" scrim="success" contained model-value persistent />
    </v-card>
</v-col>
...
<v-col cols="6">
    <v-card append-icon="mdi-open-in-new" class="py-4" color="surface-variant"
        ...
        <v-overlay opacity=".06" scrim="error" contained model-value persistent />
    </v-card>
</v-col>
...
<v-col cols="6">
    <v-card append-icon="mdi-open-in-new" class="py-4" color="surface-variant" href="https://discord.vuetifyjs.com"
        ...
        <v-overlay opacity=".06" scrim="secondary" contained model-value persistent />
    </v-card>
</v-col> -->
            </v-row>
        </v-responsive>
