<template>
  <v-app>
    ...
    <v-app-bar app color="#024059" dark flat>
      ...
      <!--   BUSCADOR CENTRAL  -->
      <v-text-field v-model="busqueda" hide-details flat dense append-inner-icon="mdi-magnify" placeholder="Búsqueda"
        style="max-width: 300px" class="mr-4" color="white" />
    ...
    <v-footer :app="false" class="d-flex px-2 py-2 pa-0 ga-2 justify-center text-caption " color="primary" border="t"
...
const opciones = ref([
  ...
  { title: "Cerrar Sesión", clase: "text-secondary font-weight-bold", icon: "mdi-logout" },
])
